...
my_foods = ["pizza", "falafel", "carrot cake", "milanesa napolitana", "ice cream", "hamburguer"]
...
my_pizzas = ["pepperoni", "cantimpalos", "napolitana"]
friends_pizzas = my_pizzas[:]

my_pizzas.append("quattro formaggi")
friends_pizzas.append("fugazzetta")
...
for his_pizzas in friends_pizzas:
    print(his_pizzas)
